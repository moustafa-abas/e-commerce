...
const dispatch=useDispatch()
  ...
  // const shuffledProducts = [...products].sort(() => Math.floor(Math.random()*3)-1 ).slice(0,9);
...
return (
...

  {
    ...
    <h5 className="my-4  mx-2">{item.title}</h5>
    ...
    <button className="py-3 d-flex justify-content-center align-items-center mx-auto my-3 w-50" onClick={()=>console.log(item._id)}> add to cart
